              ...
              >
                ...
                <div>
                  ...
                  <div className="flex justify-between items-start mb-6">
                    ...
                    {/* Tag badge */}
                    <span className="text-[10px] font-sans tracking-[0.2em] uppercase px-3 py-1 rounded-full border border-gold-primary/20 text-gold-light bg-gold-primary/10 font-semibold group-hover:border-gold-primary/50 transition-colors duration-300">
                      {service.tag}
                    </span>
                  </div>
