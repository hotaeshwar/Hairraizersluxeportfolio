        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="flex flex-col items-start select-none font-sans">
              <div className="text-lg sm:text-xl font-black tracking-[0.12em] text-[#1a1a1a] leading-none">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              {navLinks.map((link) => (
                <div key={link.name} className="text-sm font-sans tracking-widest text-[#1a1a1a]/70 font-light">
                  {link.name}
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              <div className="flex flex-col items-start select-none font-sans">
                <div className="text-lg sm:text-xl font-black tracking-[0.12em] text-[#1a1a1a] leading-none transition-colors duration-300 group-hover:text-gold-light">
                  H<span className="text-gold-primary">A</span>IR RIZER LUXE
                </div>
                <div className="flex items-center justify-between w-full my-0.5">
                  <div className="h-[1px] bg-gradient-to-r from-transparent to-gold-primary/70 flex-1" />
