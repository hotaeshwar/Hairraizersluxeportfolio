...
export default function WhatsAppWidget() {
  ...
  return (
    ...
    >
      {/* Floating tooltip */}
      <span className="absolute right-16 bg-[#0a0a0a]/90 backdrop-blur-sm border border-gold-primary/20 text-[#f5f5f3] text-[10px] font-sans tracking-widest px-3 py-1.5 rounded-lg opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none uppercase font-bold whitespace-nowrap shadow-xl">
        Book on WhatsApp
      </span>
